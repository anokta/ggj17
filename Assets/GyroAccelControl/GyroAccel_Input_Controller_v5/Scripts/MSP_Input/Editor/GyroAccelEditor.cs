...
public class GyroAccelEditor : Editor 
{
	...
	void AutoUpdateMenu()
	{
		...
		if (autoUpdateMenuEnabled) 
		{
			...
			foreach (GyroAccel.AutoUpdateList autoUpdateList in gyroAccelScript.autoUpdateList) 
			{
				...
				{
					EditorGUILayout.PrefixLabel(" ");
					autoUpdateList.enabled = EditorGUILayout.ToggleLeft("Enabled",autoUpdateList.enabled);
				}
				EditorGUILayout.EndHorizontal();
				EditorGUILayout.BeginHorizontal();
				{
	...
	void RuntimeDebugInfo()
	{
		...
		{
			EditorGUILayout.HelpBox("Current values of heading, pitch and roll",MessageType.None, false);
			EditorGUILayout.BeginHorizontal();
			EditorGUILayout.PrefixLabel ("Values at runtime:");
			EditorGUILayout.LabelField ("heading = " + gyroAccelScript.heading);
			EditorGUILayout.EndHorizontal();
			EditorGUILayout.BeginHorizontal();
			EditorGUILayout.PrefixLabel (" ");
			EditorGUILayout.LabelField ("pitch = " + gyroAccelScript.pitch);
			EditorGUILayout.EndHorizontal();
			EditorGUILayout.BeginHorizontal();
			EditorGUILayout.PrefixLabel (" ");
			EditorGUILayout.LabelField ("roll = " + gyroAccelScript.roll);
			EditorGUILayout.EndHorizontal();
		}
	} // void RuntimeDebugInfo()
